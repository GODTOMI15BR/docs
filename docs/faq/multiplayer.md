...
### Неактивна кнопка сетевой игры! {#multiplayer-disabled}
Проблема специфична для 1.16.5 при входе через оффлайн-аккаунт (аккаунт без пароля). Используйте аккаунт Ely.by, Microsoft или установите [этот мод](https://modrinth.com/mod/enablemultiplayermode).
